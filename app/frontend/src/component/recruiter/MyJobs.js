...
// //   const [openUpdate, setOpenUpdate] = useState(false);
// //   const [jobDetails, setJobDetails] = useState(job);
// //   const [skillsetInput, setSkillsetInput] = useState(""); // For new skill input
...
// //     if (skillsetInput.trim() !== "") {
// //       setJobDetails({
// //         ...jobDetails,
// //         skillsets: [...jobDetails.skillsets, skillsetInput.trim()],
// //       });
// //       setSkillsetInput("");
// //     }
// //   };
...
// //     setJobDetails({
// //       ...jobDetails,
// //       skillsets: jobDetails.skillsets.filter(
...
// //       ...jobDetails,
// //       // Ensure date format is correct for the backend
// //       deadline: new Date(jobDetails.deadline).toISOString(), 
// //     };

// //     axios
// //       .put(`${apiList.jobs}/${job._id}`, updatedDetails, {
// //         headers: {
// //           Authorization: `Bearer ${localStorage.getItem("token")}`,
// //         },
// //       })
...
// //                     fullWidth
// //                     value={skillsetInput}
// //                     onChange={(event) => setSkillsetInput(event.target.value)}
// //                     onKeyPress={(ev) => {
// //                       if (ev.key === "Enter") {
// //                         ev.preventDefault();
// //                         handleSkillAdd();
...
//     textTransform: "uppercase",
//   },
//   // New style for the smaller update modal
//   updateModalPaper: {
//     padding: "20px",
//     outline: "none",
//     display: "flex",
//     flexDirection: "column",
//     justifyContent: "center",
//     width: "600px", // Fixed width or a smaller percentage
//     maxHeight: "90vh", // Max height to ensure it doesn't overflow
//     overflowY: "auto", // Enable vertical scrolling if content exceeds maxHeight
//     alignItems: "center",
//     [theme.breakpoints.down('sm')]: { // Responsive adjustments for smaller screens
//       width: "90%",
//       maxHeight: "80vh",
//     },
//   },
...
//         className={classes.popupDialog}
//       >
//         <Paper className={classes.updateModalPaper}> {/* Apply the new style here */}
//           <Typography variant="h4" style={{ marginBottom: "10px" }}>
//             Update Details
//           </Typography>
//           <Grid
